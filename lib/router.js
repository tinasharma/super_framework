...
Router.prototype.route = function(req, res) {
  //!this.routes[req.method][req.url] ? this.counts['404']++ : this.counts[req.method][req.url]++;
  this.counts[req.method][req.url]++;
  (this.routes[req.method][req.url] || this.fourOFour)(req, res);
};

Router.prototype.writeDirectory = require(__dirname + '/writeDirectory.js');
Router.prototype.respond = require(__dirname + '/respond.js');
Router.prototype.sendFile = require(__dirname + '/sendFile.js');
